...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/hatsunem/EasyImagePicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hatsunem' => '1029286276@example.com' }
  s.source           = { :git => 'https://github.com/hatsunem/EasyImagePicker.git', :tag => s.version.to_s }
